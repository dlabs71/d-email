...
пакете `ru.dlabs.library.email.util`.
...
пакете `ru.dlabs.library.email.client`.
Основные методы описаны в таблице ниже:
...
Классы клиентов получения сообщений находятся в пакете `ru.dlabs.library.email.client.receiver`. Любой подобный класс
...
Классы клиентов отправления сообщений находятся в пакете `ru.dlabs.library.email.client.sender`. Любой подобный класс
...
данные классы в корневом пакете `ru.dlabs.library.email`.
