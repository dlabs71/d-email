...
public class MessageValidatorTests {
    ...
    public void textMessageValidationTest() {
        ...
        Exception exception = assertThrows(
            ...
            () -> MessageValidator.validate(new TextOutgoingMessage("Test subject", null, participants, null))
        );
        ...
        exception = assertThrows(
            RuntimeException.class,
            () -> MessageValidator.validate(new TextOutgoingMessage(null, null, participants, null))
        );
        assertInstanceOf(ValidationMessageException.class, exception);
        ...
        exception = assertThrows(
            RuntimeException.class,
            () -> MessageValidator.validate(new TextOutgoingMessage(null, null, new HashSet<>(), null))
        );
        assertInstanceOf(ValidationMessageException.class, exception);
