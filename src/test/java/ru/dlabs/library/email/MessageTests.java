...
public class MessageTests {
    ...
    public void textMessageValidationTest() {
        Exception exception = assertThrows(
            ...
            () -> new TextMessage(Set.of(new EmailRecipient("email@example.ru")), "Test subject", null)
        );
        ...
        exception = assertThrows(
            RuntimeException.class,
            () -> new TextMessage(Set.of(new EmailRecipient("email@example.ru")), null, null)
        );
        assertInstanceOf(ValidationMessageException.class, exception);
    ...
    public void templateMessageValidationTest() {
        Exception exception = assertThrows(
            RuntimeException.class,
            () -> new TemplatedMessage(Set.of(new EmailRecipient("email@example.ru")), "Test subject", null, null)
        );
        assertInstanceOf(ValidationMessageException.class, exception);
        assertEquals(exception.getMessage(), "Content cannot be null in the email message");
        ...
        exception = assertThrows(
            RuntimeException.class,
            () -> new TemplatedMessage(Set.of(new EmailRecipient("email@example.ru")), null, null, null)
        );
        assertInstanceOf(ValidationMessageException.class, exception);
        assertEquals(exception.getMessage(), "Subject cannot be null in the email message");
